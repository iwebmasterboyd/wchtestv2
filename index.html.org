...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#loginform">บทเรียน</a></li>
  ...
  <section id="intro">
    ...
    <div class="intro-text">
      ...
      <a onclick="popup();" class="btn-get-started scrollto">เข้าสู่ระบบ</a>
        ...
        <div class="form-horizontal box wow fadeInDown " align="center">
              <form action="" method="post" role="form" class="contactform">
                  <div class="form-group" >
                      <div class="col-sm-6">
                        <input type="text" name="username" class="form-control" id="username" placeholder="ชื่อผู้ใช้" data-rule="minlen:8" data-msg="Please enter at least 4 chars" style="max-width: 300px" />
                        <div class="validation"></div>
                      </div>
                  </div>
               <div class="form-group" >
                      <div class="col-sm-6">
                        <input type="text" name="passwd" class="form-control" id="passwd" placeholder="รหัสผ่าน" data-rule="minlen:8" data-msg="Please enter at least 4 chars" style="max-width: 300px" />
                        <div class="validation"></div>
                      </div>
                </div>
                <div><button type="submit" title="Login">เข้าสู่ระบบ</button></div><br>
              </form>
        	</div>
      </div>
    </section><!-- #about -->
